  ...
  return (
    <footer className="footer">
      <div className="footer-inner">
        <div>
          <span className="footer-name">Prashant Kumar</span>
          <p className="footer-copy" style={{ marginTop: 4 }}>
            Designed & built with ❤️ — powered by React + Vite
          </p>
        </div>

        <p className="footer-copy">© {year} Prashant Kumar. All rights reserved.</p>
